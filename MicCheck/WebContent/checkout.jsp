...
<body class="background">
	...
	if (email == null || email.equals("null")) {
		out.println("<h2>You need to login before you checkout.</h2><br/><button type='button' class='btn btn-default search-btn' onclick='location.href=\"login.jsp\"'>Login</button>");
	...
	if (productList == null || productList.isEmpty()) {
		...
		try (Connection con = DriverManager.getConnection(url, uid, pw); Statement stmt = con.createStatement();) {
			...
			out.println("<br/><h4>Order Reference Number: " + orderId + "</h4>");
			...
			rst3.next();
			out.println("<h4>Shipping to customer: "+rst3.getString(1)+"</h4>");
